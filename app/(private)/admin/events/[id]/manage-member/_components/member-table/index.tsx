...
const MemberTable = ({ id, user, event }: Props) => {
  ...
  const { data, isError, isPending, isFetching, refetch } = useEventMembers(id);
            ...
            <div className="flex w-fit items-center space-x-1 flex-auto md:justify-end justify-evenly">
                ...
                <ActionTooltip
                  ...
                  content={
                    <div className="flex items-center gap-x-2">
                      <PersonStandingIcon className="size-4" /> Add Specific
                      Members.
                    </div>
                  }
                >
                  ...
                  >
                    <p>
                      Add <span className="hidden lg:inline-block">Member</span>
                    </p>
              ...
              {!isStaff && (
                <ActionTooltip
                  ...
                  content={
                    <div className="flex items-center gap-x-2">
                      <Mails className="size-4" /> Send OTP to all members via
                      email address.
                    </div>
                  }
                >
                  ...
                  >
                    ...
                    <p>
                      Send all{" "}
                      <span className="hidden lg:inline-block">OTP</span>
                    </p>
                    {isBroadcasting ? (
                      <LoadingSpinner />
                    ) : (
              ...
              {!isStaff && (
                ...
                >
                  ...
                  >
                    <p>
                      csv <span className="hidden lg:inline-block">import</span>
                    </p>
                    <Plus className="w-4 h-4" />
                  </Button>
                </ActionTooltip>
