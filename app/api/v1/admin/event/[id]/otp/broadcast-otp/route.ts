...
import { sendMail, sendMailBatched } from "@/lib/mailer";
      ...
      mails.push({
        ...
        mailTemplate: {
          ...
          payload: {
            ...
            ecoopLogo: `${process.env.DEPLOYMENT_URL}/images/e-coop-logo.webp`,
          },
        },
      });
    });

    const { errorSend, successSend } = await sendMailBatched(
      mails,
      new ResendMailer(),
    );
